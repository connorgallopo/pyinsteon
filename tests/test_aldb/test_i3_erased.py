...
class TestErasedAldbHandling(unittest.TestCase):
    ...
    def test_add_record_rejects_phantom_above_first(self):
    ...
    def test_calc_next_record_returns_missing(self):
    ...
    def test_calc_next_record_stops_at_hwm(self):
    ...
    def test_close_erased_aldb_requires_contiguous_chain(self):
